...
function EventScriptStartup()
	...
	System.RegisterScriptKey(KEY_V,MODIFIER_CUSTOM,"FindNextOccurrence","Find next occurrence")
...
function FindNextOccurrence()
	System.OutputDebugString("FindNextOccurrence")
	VF.FindNext(DIRECTION_VF_NEXT_OCCURRENCE)
end
