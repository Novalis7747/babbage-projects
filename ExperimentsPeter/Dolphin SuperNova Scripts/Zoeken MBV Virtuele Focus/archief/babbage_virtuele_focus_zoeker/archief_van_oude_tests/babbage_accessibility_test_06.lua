...
--[[
	20151104: Sowieso nog te doen:
	* CAPS-LOCK + ; zoeken door entrie_list[index], naar de volgende index navigeren, plaatsmarkering functie
	* Zoek en &Tab: moet nog werkend gemaakt worden, een TAB toets simuleren geeft niet het juiste resultaat
--]]
...
function PerformSearch()
	...
	elseif selected_action==3 then
		...
		VF.Action(CLICK_MOVE_ONLY)
		VF.ChooseFocus(FOCUS_LIVE) -- Live focus moet nog naar de virtuele focus verplaatst worden...
		System.OutputDebugString(L"LIVE FOCUS")
		System.SimulateKeyPress(KEY_TAB,MODIFIER_NONE)
		System.OutputDebugString(L"TAB")
