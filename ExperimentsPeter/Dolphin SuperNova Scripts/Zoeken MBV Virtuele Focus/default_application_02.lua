...
function PerformSearch()
	...
	elseif application_title==window_title then
		System.OutputDebugString(L"Venstertitel komt overeen")
		if selected_action==1 then
			VF.ChooseFocus(FOCUS_VF)
			VF.Move(MOVE_VF_AREA_TOP,0)
		...
		elseif selected_action==3 then
			...
			VF.Action(CLICK_LEFT)
			VF.ChooseFocus(FOCUS_BACK)
			System.OutputDebugString(SCREEN_FOCUS)
			System.Sleep(200)
